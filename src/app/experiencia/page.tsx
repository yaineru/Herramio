...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Explora el universo de las 44 herramientas de Herramio en una página interactiva: mueve el mouse, pasa por encima de una herramienta y entra directo a usarla.",
  path: "/experiencia",
});
        ...
        <Reveal>
          <div className="rounded-3xl bg-slate-900 px-8 py-14 text-center">
            ...
            <p className="mx-auto mt-2 max-w-md text-slate-300">
              Sin cuentas, sin instalar nada, sin límites. 44 herramientas gratis, hoy.
            </p>

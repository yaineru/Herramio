...
export function UrlEncoderTool() {
  ...
  return (
    <Card className="p-6">
      ...
      <Label htmlFor="url-encoder-input">{mode === "encode" ? "Texto o URL a codificar" : "Texto codificado a decodificar"}</Label>
      <textarea
        id="url-encoder-input"
        value={input}
        onChange={(e) => setInput(e.target.value)}
        placeholder={mode === "encode" ? "https://ejemplo.com/buscar?q=hola mundo" : "https%3A%2F%2Fejemplo.com..."}
        rows={5}
        spellCheck={false}
